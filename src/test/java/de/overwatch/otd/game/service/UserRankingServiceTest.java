package de.overwatch.otd.game.service;
...
public class UserRankingServiceTest {
    ...
    private UserRankingService userRankingService = new UserRankingServiceImpl();
    ...
    @Before
    public void init(){
        this.userRankingService = new UserRankingServiceImpl();
